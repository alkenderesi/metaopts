...
def ga(model_weights, model_fitness, generation_limit, fitness_limit, population_size, elite_size, crossover_rate, mutation_rate):
    """
    Implemetation of a Genetic Algorithm.
    The algorithm uses elitism, roulette wheel selection, multipoint crossover and gaussian mutation.
    ...
    Args:
        ...
        fitness_limit: `float` - Fitness value threshold for termination.
    ...
    def sort_population():
        ...
        # Assign new order to population and fitness values
    ...
    def multipoint_crossover():
        ...
        for p in population:
            ...
            # Shape of ranndomly generated crossover points
